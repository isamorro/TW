...
<div class="mb-8">
    ...
    <p class="mt-1 text-sm text-slate-500">Crea tu usuario para gestionar tu actividad.</p>
</div>
...
<form action="{{ route('register.store') }}" method="POST" class="space-y-5">
    ...
    <button type="submit" class="mt-2 flex w-full justify-center rounded-md bg-emerald-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600">
        Registrarse
    </button>
</form>
...
<div class="mt-8 text-center text-sm text-slate-600">
    <p>
        ¿Ya tienes cuenta?
        <a href="{{ route('login') }}" class="font-semibold text-emerald-600 transition hover:text-emerald-500 hover:underline">Inicia sesión</a>
    </p>
</div>
@endsection